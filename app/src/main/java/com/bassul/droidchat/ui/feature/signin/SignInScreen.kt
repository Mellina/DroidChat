...
import com.bassul.droidchat.ui.components.PrimaryTextField
import com.bassul.droidchat.ui.theme.BackgroundGradient
import com.bassul.droidchat.ui.theme.DroidChatTheme

@Composable
fun SignInRoute(
    viewModel: SignInViewModel = viewModel(), navigateToSignUp: () -> Unit
) {

    val formState = viewModel.formState
    SignInScreen(formState, viewModel::onFormEvent, onRegisterClick = navigateToSignUp)
}
...
fun SignInScreen(
    ...
    Column(
        ...
        PrimaryTextField(value = formState.password,
            onValueChange = {
        ...
        val annotatedString = buildAnnotatedString {
            ...
            addStyle(
                style = androidx.compose.ui.text.SpanStyle(
                    color = Color.White
                ), start = 0, end = registerTextStartIndex
            )
...
private fun SignInScreenPreview() {
    DroidChatTheme {
        SignInScreen(formState = SignInFormState(), {}, onRegisterClick = {})
    }
}